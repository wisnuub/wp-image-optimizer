...
class WPIO_Remote {
    ...
    public static function convert( $source_path, $format = 'webp', $quality = 82 ) {
        ...
        $endpoint = trailingslashit( $remote_url ) . 'convert';
        ...
        $ftype     = wp_check_filetype( $source_path );
        $mime      = ! empty( $ftype['type'] ) ? $ftype['type'] : 'application/octet-stream';
    ...
    public static function test_connection() {
        ...
        $url = trailingslashit( $remote_url ) . 'ping';
